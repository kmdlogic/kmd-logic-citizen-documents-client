autorest --input-file=citizenDocuments.swagger.json --output-folder=. --namespace=Kmd.Logic.CitizenDocuments.Client --csharp --override-client-name=InternalClient --add-credentials --legacy
